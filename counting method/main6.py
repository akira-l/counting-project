...
with tf.Session(graph=g2) as sess:
    ...
    for i in range(1,ts_num+1):
        ...
        if i%100==0:
            set_frame = 1-i/(ts_num-1000)
            if set_frame <= 0:
                set_frame = 0
        #feed_dict={net.xs:train_batch,net.ys:ground_batch,net.training_flag:True}
        feed_dict={net.x_1:data_x1, net.x_2:data_x2, net.x_3:data_x3, net.dframe1:frame1_batch, net.ys:ground_batch, net.training_flag:True, net.frame_para:set_frame}
        ...
        if i%get_test_loss==0:
            ...
            feed_dict = {net.x_1:tdata_x1, net.x_2:tdata_x2, net.x_3:tdata_x3, net.dframe1:test_frame1, net.ys:test_ground, net.training_flag:False, net.frame_para:0}
            ...
            if i%record_test_map==0:
                feed_dict = {net.x_1:tdata_x1, net.x_2:tdata_x2, net.x_3:tdata_x3, net.dframe1:test_frame1, net.training_flag:False, net.frame_para:0}
