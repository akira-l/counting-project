...
class Model_net(object):
    def __init__(self):
        ...
        self.frame_para = tf.placeholder(tf.float32)
        
        self.merge_frame = self.frame_para*self.merge_frame
    ...
    def model(self, x_input1, x_input2, x_input3, x_frame):
        ...
        with tf.variable_scope('delta_frame'):
            x_frame = self.frame_para*x_frame
            ...
            hF_conv2 = tf.nn.relu(tf.nn.conv2d(hF_conv1, WF_conv2, strides=[1,1,1,1], padding='SAME')+bF_conv2)
        ...
        with tf.variable_scope('merge_model'):
            ...
            merge_weight = self.weight_variable([1,1,2,1])
