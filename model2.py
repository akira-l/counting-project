...
class Model_net(object):
    def __init__(self):
        ...
        self.prediction = self.model(self.x_input1, self.x_input2, self.x_input3)
    ...
    def model(self, x_input1, x_input2, x_input3):
        ...
        with tf.variable_scope('model1'):
            ...
            h_conv3 = tf.nn.relu(tf.nn.conv2d(h1_pool2,W_conv3,strides=[1,1,1,1],padding='SAME')+b_conv3)
        ...
        with tf.variable_scope('merge_model'):
            ...
            merge_weight = self.weight_variable([1,1,3,1])
